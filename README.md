...
一个可安装到 Hermes 的本地 EVA 标题卡 skill。它以 [itorr/eva-title](https://github.com/itorr/eva-title) 的 16 种版式为参考，用原生 Node Canvas/Skia 输出 PNG；运行时不需要 Chrome、Playwright、网页服务或远程字体代理。
...
版式灵感、简繁映射和 Matisse 字形清单来自 [itorr/eva-title](https://github.com/itorr/eva-title)，其随附参考文件适用上游 MIT 许可证，见 [third_party/eva-title-MIT-LICENSE](third_party/eva-title-MIT-LICENSE)。思源宋体来自 [Adobe Source Han Serif](https://github.com/adobe-fonts/source-han-serif)，本仓库不得提交或分发本机字体文件。
